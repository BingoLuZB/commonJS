...
// comUrl的意义 process.env.NODE_ENV === "production" ? 'https://api.julefun.com' : '/replaceUrl',  //这里跨域是配置成了api的
// 多个不同域名请求的时候，就不要写baseURL
axios.defaults.baseURL = config.comUrl
// 请求超时时间
